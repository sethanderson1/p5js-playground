    ...
    p.draw = () => {
        ...
        for (var i = 1; i < options.Nums; i++) {
            ...
            if (options.ColorMode == 'Linera Gradient') {
                ...
                from = p.color(options.Color1);
                middle = p.color(options.Color2);
                to = p.color(options.Color3);
                between1 = p.lerpColor(from, middle, percent1);
                between2 = p.lerpColor(middle, to, percent2);
