...
const sketch = p => {
    ...
    const alphaHex = '11'
    const colorOne = colorSchemes[9][0] + alphaHex
    const colorTwo = colorSchemes[9][1] + alphaHex
    const colorThree = colorSchemes[9][2] + alphaHex
